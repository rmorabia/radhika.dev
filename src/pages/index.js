...
export default () => (
  <Layout>
    ...
    <p>Currently, I work with React, Vue, and Node.js. I'm also learning Python. Down the line, I'm hoping to gain a good understanding of Java and CS fundamentals. <Link to={'/blog'}>Read about what I'm learning on my blog.</Link> Usually updated weekly.</p>
    ...
    <form action="https://tinyletter.com/rmorabia" method="post" target="popupwindow" onsubmit="window.open('https://tinyletter.com/rmorabia', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true">
      <input type="email" name="email" id="tlemail" placeholder="hi@whatever.com"></input>
