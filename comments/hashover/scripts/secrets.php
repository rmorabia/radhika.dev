<?php
	...
	$encryption_key		= 'radhikam';			// Unique 8 to 32 character encryption key
	$notification_email	= 'hi@rmorabia.com';	// E-mail for notification of new comments
	$admin_nickname		= 'rmorabia';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'comments';			// Password to gain admin rights
